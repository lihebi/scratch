...
\begin{figure*}
  ...
  \begin{tikzpicture} [
    ...
    \matrix (app) [
      ...
      \node (n3) {};&
      \node (n4) {};\\
      \node [fill=green!40!black, text=white, font=\Large] {Detect and Confirm Code Clones};&
      \node [fill=green!40!black, text=white, font=\Large] {Compute Syntactic Constraints};&
      \node [fill=green!40!black, text=white, font=\Large] {Generate Bug Signatures};&
      \node [fill=green!40!black, text=white, font=\Large] {Interactive IDE Tools};\\
      \node
      [
        % fill=red!50!black,
        % dashed
